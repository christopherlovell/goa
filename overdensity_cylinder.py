...
#     half_deltac = [5.1, 3.5, 6.2, 3.3, 5.2, 3.8, 4.4, 1.9, 4.7]
    ...
    dc_str = str(half_deltac).replace('.','p')
    ...
    out_stats = overdensity_cylinder(gals, random, r, half_deltac)

    pcl.dump(out_stats, open('%s/dgal_z%s_r%s_dc%s.p'%(out_directory,z,r_str,dc_str), 'w'))
